...
CREATE TABLE `Product` (
  ...
  KEY `fk_Product_Supplier` (`Supplier_idSupplier`),
  ...
  CONSTRAINT `fk_Product_Supplier` FOREIGN KEY (`Supplier_idSupplier`) REFERENCES `Supplier` (`idSupplier`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Product` VALUES (1,'Manzana','Manzana verde',1,30,50,1,1),(2,'Pastel de chocolate','Pan de chocolate y tres leches',1,250,50,4,2),(3,'Tequila','tequila reposado',0,400,0,2,6),(4,'Cocacola','Cocacola ligth 3 litros',1,45,200,7,5);
...
-- Dump completed on 2021-05-26 22:39:45
